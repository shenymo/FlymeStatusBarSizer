...
final class SettingsStore {
    ...
    static final int DEFAULT_LAUNCHER_STACK_ENTRY_LIGHT_RADIUS = 2;
    ...
    static final String[] BOOLEAN_KEYS = {
            ...
            KEY_CAMERA_CIRCLE_BATTERY_TINT_ENABLED,
    ...
    static boolean defaultBoolean(String key) {
        switch (key) {
            ...
            case KEY_CAMERA_CIRCLE_BATTERY_TINT_ENABLED:
                return DEFAULT_CAMERA_CIRCLE_BATTERY_TINT_ENABLED;
